...
public class AllAmiibo extends javax.swing.JFrame {
    ...
    private void AllAmiiboJListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_AllAmiiboJListValueChanged
        ...
        */
        try {
            URL imgUrl = new URL(sortedAmiibo.get(AllAmiiboJList.getSelectedIndex()).getImage());
            image = ImageIO.read(imgUrl);
            int newW = pictureLabel.getWidth();
            image = image.getScaledInstance(newW, 161, Image.SCALE_SMOOTH);
            ...
            amiiboDescription.setText((sortedAmiibo.get(AllAmiiboJList.getSelectedIndex()).getInfo()));
        } catch (IOException e){
